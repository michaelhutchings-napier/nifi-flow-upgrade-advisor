...
FIXTURE_JSON="${ROOT_DIR}/demo/fixtures/h2-dbcp-1.21-flow.json"
RULE_PACK="${ROOT_DIR}/examples/rulepacks/nifi-1.21-to-1.22.official.yaml"
OUT_DIR="${ROOT_DIR}/demo/out/h2-dbcp-1.21-to-1.22"
...
echo "Running H2 DBCP 1.21.0 -> 1.22.0 manual-change demo"
...
echo "  - H2 JDBC usage is flagged as manual-change"
